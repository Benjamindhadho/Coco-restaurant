...
/**
 * Location / hours / contact section on the menu page.
 */
  ...
  return (
    <section className="relative overflow-hidden bg-[#5B0017]">
      ...
      <div className="relative mx-auto grid max-w-[1300px] items-center gap-10 px-6 py-20 lg:grid-cols-2 lg:px-10 lg:py-24">
        <Reveal>
          <div className="max-w-md space-y-8 rounded-xl bg-[#243054] p-8 shadow-xl shadow-black/30 ring-1 ring-white/10 sm:p-10">
            {details.map((detail) => (
